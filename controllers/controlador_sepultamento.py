...
class ControladorSepultamento:
    ...
    def abre_tela(self):
        ...
        lista_opcoes = {
            ...
            1:
                self
                .cadastrar_sepultamento,

            2:
                self
                .alterar_sepultamento,

            3:
                self
                .excluir_sepultamento,

            4:
                self
                .listar_sepultamentos,
